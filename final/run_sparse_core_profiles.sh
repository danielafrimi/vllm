...
#SBATCH --job-name=sparse-core-profiles
#SBATCH --gres=gpu:1
#SBATCH --time=01:30:00
#SBATCH --output=slurm-sparse-core-profiles-%j.out
...
DECODE_REPORT="profiles/final_profile_decode_sparse_core_b64_kv2_64k_ab512_${STAMP}"
PREFILL_REPORT="profiles/final_profile_chunk_prefill_sparse_core_b1_q8192_128k_ab1024_${STAMP}"
