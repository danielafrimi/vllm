...
class ClsToken(nn.Module):
    def __init__(self, ndim: int,
        ...
        if enabled:
            ...
            print("in intervit cls token init num_registers: ", self.num_registers)
...
class ViTPatchGenerator(nn.Module):
    def __init__(self,
                #  config: PretrainedConfig,
                 patch_size: int,
                 embed_dim: int,
                 input_dims: input_dim_t, # todo 
                 abs_pos: bool = True,
                 normalize_patches: bool = False,
                 cls_token: bool = False,
                 max_input_dims: Optional[input_dim_t] = None, # todo 
